...
@Service
public class Ping2PlusServiceImpl implements Ping2PlusService {
	...
	public String createCharge(Map chargeMap) throws Exception {
		chargeMap.put("extra", channelExtra(chargeMap.get("channel").toString()));
		return Charge.create(chargeMap).toString();
	}

	public String retrieve(String id) throws Exception {
		return Charge.retrieve(id, new HashMap<String, Object>()).toString();

	}

	public String reverse(String id) throws Exception {
		return Charge.reverse(id).toString();
	}
}
